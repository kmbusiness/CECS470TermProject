...
<HTML lang="en">
	...
	<body>
		<p> 
			...
			<br/>
			<img src="images/oralbfloss.jpg" alt="Oral-B Complete Deep Clean Ultra floss"/>
			<br/>
			3. Clean your tongue; the tongue has a lot of bacteria, plus it's one of the major causes of bad breath, so use a
			tongue scraper.
			<br/>
			4. Use a alcohol-free mouthwash (Dr. John recommends Act Restoring Anticavity Flouride Mouthwash)
			<br/>
