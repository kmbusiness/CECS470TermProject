  ...
  <body>
      ...
      <div class="form-container">
    	...
    	<form action="create_account.php" method="post">
          ...
          <button type="submit" class="createbtn"><i class="fa fa-paper-plane-o" aria-hidden="true"></i>&nbsp; Create Account</button>
          <button type="reset" class="cancelbtn"><i class="fa fa-window-close" aria-hidden="true"></i>&nbsp; Clear Form</button>
    		</form>
    </div>
