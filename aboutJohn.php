...
<html lang="en">
  ...
  <body>
    ...
    <div class = "ontheright">
        <img src="images/drjohn.jpg" alt = "Dr. John"/> 
    </div>
        <div class = "ontheleft">
      <h2>Meet the Staff</h2>
        ...
        <h3>Dental Assistants</h3>
          <h4>Vinnie Vu</h4>
        <p>Vinnie Vu graduated from California State University, Long Beach with a Bachelors degree in Public Health. He attended Coastline Regional Occupation Program with certifications in Dental Assistance.</p>

        <h4>Allen Muy</h4>
        <p>Allen graduated from California State University, Long Beach with a Bachelors degree in Health Science. He received his certification in Dental Assistance in 2015.</p> 

        <h3>Dental Receptionist</h3>
        <h4>Chi Phan</h4>
        <p>Chi graduated from California State University, Long Beach with a Bachelors degree in Communication. He has been the dental receptionist for the past 20 years for Dr. John's Dentistry. </p>


    </div>


    <div class = "ontheright assist">
